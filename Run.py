...
#Tijd bijhouden
    if disp.tijd_over(start_tijd,tijd_moeilijkheid)[0] is True:
        text = myFont.render(("Tijd: " + str(disp.tijd_over(start_tijd,tijd_moeilijkheid)[1])  +" seconden"), 1, wit)
...
while spel_klaar is True:
    ...
    endFont = pygame.font.SysFont("Javanese Text", 40) #font en lettergrootte kiezen
