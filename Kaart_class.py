...
class kaart:
    ...
    # welke eigenschap is er nodig om een set te kunnen maken. Let op checkt maar voor een eigenschap
    def welk(self, eerste, tweede):
        if eerste + tweede == 2:
            return 1
        if eerste + tweede == 1:
            return -1
    ...
    # als twee kaarten zijn gekozen staat de derde kaart vast. We maken een functie om te bepalen welke dit is.
    def derde_kaart(self, ander):
